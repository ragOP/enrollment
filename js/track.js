...
var campaignID = "6850956fc75e515564371b3f";
...
var initialSrc = "https://go.nationalsubsidyhelp.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("go.nationalsubsidyhelp.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://go.nationalsubsidyhelp.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://go.nationalsubsidyhelp.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
